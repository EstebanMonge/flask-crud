...
Revision ID: eb701d363477
Revises: e74d73d2e070
Create Date: 2021-05-20 13:37:56.118851
...
revision = 'eb701d363477'
down_revision = 'e74d73d2e070'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('ho_id', 'platform', 'owner')
    )
